  ...
  const getActionText = () => {
    if (isBlocked) {
      return {
        ...
        buttonText: isConfirming ? 'Confirm Unblock' : 'Unblock Card',
      ...
      return {
        ...
        buttonText: isConfirming ? 'Confirm Block' : 'Block Card',
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                  {isConfirming ? actionConfig.confirmText : actionConfig.description}
                </p>
